...
class TestFunctions:
    ...
    def test_list_functions(self, azure_http):
        azure_http.put(f"/azure/functions/{_APP}/functions/fn-list-1", json={"code": ""})
        azure_http.put(f"/azure/functions/{_APP}/functions/fn-list-2", json={"code": ""})
    ...
    def test_get_function(self, azure_http):
        azure_http.put(f"/azure/functions/{_APP}/functions/fn-get-me", json={"code": ""})
    ...
    def test_delete_function(self, azure_http):
        azure_http.put(f"/azure/functions/{_APP}/functions/fn-delete-me", json={"code": ""})
    ...
    def test_delete_then_get_returns_404(self, azure_http):
        azure_http.put(f"/azure/functions/{_APP}/functions/fn-del-get", json={"code": ""})
    ...
    def test_invoke_returns_result(self, azure_http):
        azure_http.put(f"/azure/functions/{_APP}/functions/fn-invoke", json={"code": "def main(): return 42"})
        r = azure_http.post(
