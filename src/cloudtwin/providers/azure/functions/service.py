...
class AzureFunctionsService:
    ...
    async def create_function(
        self, app: str, name: str, code: str = ""
    ) -> AzureFunction:
        ...
        await self._telemetry.emit(
            "azure", "functions", "create_function", {"app": app, "name": name}
        )
        return saved
    ...
    async def delete_function(self, app: str, name: str) -> None:
        ...
        await self._telemetry.emit(
            "azure", "functions", "delete_function", {"app": app, "name": name}
        )
    ...
    async def invoke(self, app: str, name: str, payload: str = "{}") -> str:
        ...
        await self._telemetry.emit(
            "azure", "functions", "invoke", {"app": app, "name": name}
        )
        return response
